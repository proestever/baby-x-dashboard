...
let pairsData = []; // Store pairs for wallet stats

// Fetch General Token Info
async function fetchTokenInfo(tokenAddress, decimals, nameId, holdersId, supplyId) {
    try {
        const tokenResponse = await fetch(`http://localhost:3000/proxy/pulsechain/tokens/${tokenAddress}`);
        ...
        const supplyResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${tokenAddress}/query-read-method`, {
            method: "POST",
...
async function fetchPairs() {
    try {
        const response = await fetch(`http://localhost:3000/proxy/dexscreener`);
...
async function fetchWalletStats() {
    ...
    try {
        // Baby X Balance
        const babyXBalanceResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${babyXAddress}/query-read-method`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                args: [walletAddress],
        ...
        // X Balance
        const xBalanceResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${xAddress}/query-read-method`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                args: [walletAddress],
        ...
        // X Rewards
        const rewardsResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${babyXAddress}/query-read-method`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                args: [walletAddress],
        ...
        // Prices
        const xPriceResponse = await fetch(`http://localhost:3000/proxy/pulsechain/tokens/${xAddress}/price`);
        ...
        for (const pair of pairsData) {
            ...
            const lpBalanceResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${lpTokenAddress}/query-read-method`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    args: [walletAddress],
            ...
            const lpTotalSupplyResponse = await fetch(`http://localhost:3000/proxy/pulsechain/smart-contracts/${lpTokenAddress}/query-read-method`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    args: [],
